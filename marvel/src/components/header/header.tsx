...
const Header = () => { 
	  ...
	  <menu>
	  <div><NavLink to={Paths.main} className="menu-home">Home</NavLink></div>
	  <div><NavLink to={Paths.characters} className="menu-characters">Characters</NavLink> </div>
	  <div><NavLink to={Paths.comics} className="menu-comics">Comics</NavLink></div>
	  </menu>
