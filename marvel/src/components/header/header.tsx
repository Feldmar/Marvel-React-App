...
const Header = () => { 
  	return(
		...
		<Menu mode="horizontal" defaultSelectedKeys={['one']} overflowedIndicator  theme="dark">
    <Menu.Item key="one" >
			<NavLink to={Paths.main}>Home</NavLink>
    </Menu.Item>
    <Menu.Item key="two" >
			<NavLink to={Paths.characters}>Characters</NavLink> <br />
    </Menu.Item>
    <Menu.Item key="three" >
			<NavLink to={Paths.comics}>Comics</NavLink>
    </Menu.Item>
  	</Menu>
		</header>
  	)
